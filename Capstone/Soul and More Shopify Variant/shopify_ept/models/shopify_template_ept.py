...
class ShopifyProductTemplateEpt(models.Model):
    ...
    def sync_variant_data_with_existing_template(self, instance, variant_data, template_data, shopify_template,
        ...
        for variant in variant_data:
            ...
            message = self.check_sku_barcode(sku, barcode, name, list_price, variant_id,
                                             instance.shopify_sync_product_with)
            if message:
    ...
    def check_sku_barcode(self, sku, list_price, barcode, name, variant_id, match_by):
        """
    ...
    def shopify_prepare_template_dic(self, template_data, instance, product_category):
        ...
        if template_data.get("variants")[0]:
            variants =template_data.get("variants")[0]
    ...
    def shopify_search_odoo_product_variant(self, shopify_instance, variant_id, product_sku, barcode, list_price):
        """
    ...
    def create_or_update_shopify_template(self, template_dict, variant_length, shopify_template, odoo_product=False,
        ...
        if shopify_template:
            ...
            product_variant = shopify_template.product_tmpl_id.product_variant_id
            product_variant.write({
                'lst_price': template_dict.get("lst_price"),
            })
        else:
            if odoo_product:
